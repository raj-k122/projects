...
#Paddle and ball collision
    if  ball.xcor() > 415 and (ball.ycor() < paddle_b.ycor() + 60 and ball.ycor()> paddle_b.ycor()-60):
        ball.dx *= -1

    if  ball.xcor() < -415 and (ball.ycor() < paddle_a.ycor() + 60 and ball.ycor()> paddle_a.ycor()-60):
        ball.dx *= -1
